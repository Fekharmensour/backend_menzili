...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'number_persons' => 'عدد الأشخاص',
        'is_ready' => 'جاهز',
        'is_negotiable' => 'قابل للتفاوض',
        'main_image' => 'الصورة الرئيسية',
        'rent_duration_id' => 'مدة الكراء',
        'type_id' => 'نوع الإعلان',
        'location' => 'الموقع',
        'location.latitude' => 'خط العرض',
        'location.longitude' => 'خط الطول',
        'location.city_id' => 'المدينة',
        'location.altitude' => 'الارتفاع',
        'location.zip_code' => 'الرمز البريدي',
        'categories' => 'الأصناف',
        'features' => 'المميزات',
        ...
        'image' => 'الصورة',
        'amount' => 'المبلغ',
        'card_id_front' => 'صورة بطاقة الهوية من الأمام',
        'card_id_back' => 'صورة بطاقة الهوية من الخلف',
        'document' => 'الوثيقة',
    ],
