...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes ci-dessous contiennent les messages d'erreur par défaut utilisés
    | par la classe de validation. Certains de ces règles ont plusieurs variantes
    | comme les règles de taille. N'hésitez pas à ajuster ces messages.
    |
    */
    ...
    'ascii' => 'Le champ :attribute ne doit contenir que des caractères ASCII d’un octet et des symboles.',
    ...
    | des attributs en utilisant la convention "attribut.règle".
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes ci-dessous sont utilisées pour remplacer le placeholder
    | d'attribut par quelque chose de plus lisible comme "Adresse e-mail".
    |
    */
    ...
    'attributes' => [
        ...
        'otp_expires_at' => 'Expiration du code',
        'is_active' => 'Statut d\'activation',
        'phone_verified_at' => 'Heure de vérification du téléphone',
        'device_token' => 'Jeton d\'appareil',
        ...
        'number_persons' => 'Nombre de personnes',
        'is_ready' => 'Prêt',
        'is_negotiable' => 'Négociable',
        'main_image' => 'Image principale',
        'rent_duration_id' => 'Durée de location',
        'type_id' => 'Type d\'annonce',
        'location' => 'Emplacement',
        'location.latitude' => 'Latitude',
        'location.longitude' => 'Longitude',
        'location.city_id' => 'Ville',
        'location.altitude' => 'Altitude',
        'location.zip_code' => 'Code postal',
        'categories' => 'Catégories',
        'features' => 'Caractéristiques',
        'near_places' => 'Lieux à proximité',
        'images' => 'Images',
        ...
        'image' => 'Image',
        'amount' => 'Montant',
        'card_id_front' => 'Carte d\'identité recto',
        'card_id_back' => 'Carte d\'identité verso',
        'document' => 'Document',
    ],
