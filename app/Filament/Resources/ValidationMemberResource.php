                    ...
                    InfolistComponents\ImageEntry::make('card_id_front_path')
                        ...
                        ->action(
                            \Filament\Actions\Action::make('view_front')
                                ...
                                ->modalContent(fn ($record) => $record ? new \Illuminate\Support\HtmlString('<img src="/secure-documents/' . $record->card_id_front_path . '" style="width: 100%; height: auto;">') : null)
                    ...
                    InfolistComponents\ImageEntry::make('card_id_back_path')
                        ...
                        ->action(
                            \Filament\Actions\Action::make('view_back')
                                ...
                                ->modalContent(fn ($record) => $record ? new \Illuminate\Support\HtmlString('<img src="/secure-documents/' . $record->card_id_back_path . '" style="width: 100%; height: auto;">') : null)
                                ->modalSubmitAction(false)
                                ->modalCancelAction(false)
                        )
                    ...
                    InfolistComponents\ImageEntry::make('document_path')
                        ...
                        ->action(
                            \Filament\Actions\Action::make('view_doc')
                                ...
                                ->modalContent(fn ($record) => $record ? new \Illuminate\Support\HtmlString('<img src="/secure-documents/' . $record->document_path . '" style="width: 100%; height: auto;">') : null)
                                ->modalSubmitAction(false)
                                ->modalCancelAction(false)
                        )
                        ->columnSpanFull()
